...
import {
  ...
  todayIso
} from "./accountability-core.js?v=20260911-contracts-r1";
...
const contractSource = window.CABW_CONTRACTS_SOURCE || {};
const contractBaseDate = formatDate(contractSource.referenceDate, "não informada");
...
function qualityWarnings(contract) {
  const warnings = [...(Array.isArray(contract.sourceWarnings) ? contract.sourceWarnings : [])];
